  ...
  return (
    <header className="h-14 bg-white border-b border-gray-100 flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/profile" className="flex items-center gap-2.5 pl-3 border-l border-gray-100 hover:opacity-80 transition">
          <div className="w-7 h-7 rounded-lg bg-yellow-500 flex items-center justify-center shadow-sm">
            <span className="text-[10px] font-bold text-yellow-950">{initials}</span>
          </div>
